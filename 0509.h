...
void caluate(neuro *neuro_data, RDATA *R_data, double result[60]) {
	...
	// 2016/3/2補上else，在此之前當neuro_data[0].none_zero+neuro_data[1].none_zero-R_data[0].none_zero == 0時
	// result[59]會等於 R_data[0].none_zero 0
	// 2016/3/4 原使用range算gobal值 改為使用none_zero算
    }
}
